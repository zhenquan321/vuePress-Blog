...
* [`[Basic]` Promise](/node/event-async.md#promise)
* [`[Doc]` Events (事件)](/node/event-async.md#events)
* [`[Doc]` Timers (定时器)](/node/event-async.md#timers)
* [`[Point]` 阻塞/异步](/node/event-async.md#阻塞异步)
* [`[Point]` 并行/并发](/node/event-async.md#并行并发)
